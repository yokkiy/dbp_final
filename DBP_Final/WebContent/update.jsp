...
<title>所有カードにチェック</title>
</head>
<body>
<form action="Controller" method="post">
<p><a href=recordListTop.jsp>TOP</a></p>
<a href="./Controller?check=girl1" >所持魔法少女一覧</a>
<%
...
out.print("魔法少女");
String table = "<table border=3><tr><td>チェック</td><td>画像</td><td>名前</td><td>レアリティ</td><td>属性</td><td>コネクト</td><td>マギア</td><td>ドッペル</td></tr>";
for(magicalGirl m:list){
	...
	pic="<img src ="+"./データベース/魔法少女/"+card+" "+"width="+"130"+" "+"height="+"200"+ ">";
     ...
     table +="<tr><td><input type="+"checkbox"+" name="+"mg "+"value="+m.getID()+">"
    		 +"</td><td>"
    		 +pic+"</td><td>"
    		 +name+"</td><td>"
    		 +rarity+"</td><td>"
...
%>
<button type="submit" name="check" value="get1">取得済み</button>
</form>
</body>
</html>