...
<p>
<button type="submit" name="check" value="delete">詳細削除</button>
<button type="submit" name="check" value="add">詳細追加</button>
<button type="submit" name="check" value="girl1">取得済み魔法少女一覧</button>
<button type="submit" name="check" value="get">未取得魔法少女一覧</button>
